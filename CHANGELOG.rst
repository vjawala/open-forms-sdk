...
* The new renderer library (replacing ``formio.js``) is feature complete and stable. A
  ...
  - In the email verification flow you now have feedback that the email is verified.
...
* [#5727] Fixed map overlays not being shown in the form submission summary page.
